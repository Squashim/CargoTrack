...
namespace CargoTrack.Modules.Transport.Database.Migrations
{
    ...
    [Migration("20260224175853_AddTransportJobRelations")]
    partial class AddTransportJobRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CargoTrack.Modules.Transport.Entities.TransportJob", b =>
                {
                    ...
                    b.HasOne("CargoTrack.Modules.Transport.Entities.Driver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CargoTrack.Modules.Transport.Entities.Trailer", "Trailer")
                        .WithMany()
                        .HasForeignKey("TrailerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CargoTrack.Modules.Transport.Entities.Truck", "Truck")
                        .WithMany()
